...
### DEV Environment
DEV_APP_ENDPOINT, DEV_APP_ENDPOINT_V2, DEV_PARAGON_ENDPOINT, DEV_NHS_LOGIN_URL, DEV_NHS_UPDATE_URL, DEV_OIDC_DISCOVERY_URL, DEV_PARAGON_HEADER, DEV_PARAGON_TOKEN
### UAT Environment
UAT_APP_ENDPOINT, UAT_APP_ENDPOINT_V2, UAT_PARAGON_ENDPOINT, UAT_NHS_LOGIN_URL, UAT_NHS_UPDATE_URL, UAT_OIDC_DISCOVERY_URL, UAT_PARAGON_HEADER, UAT_PARAGON_TOKEN
### PROD Environment
PROD_APP_ENDPOINT, PROD_APP_ENDPOINT_V2, PROD_PARAGON_ENDPOINT, PROD_NHS_LOGIN_URL, PROD_NHS_UPDATE_URL, PROD_OIDC_DISCOVERY_URL, PROD_PARAGON_HEADER, PROD_PARAGON_TOKEN
### CERTIFICATE PINNING
