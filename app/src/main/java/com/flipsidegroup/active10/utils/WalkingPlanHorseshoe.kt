...
class WalkingPlanHorseshoe @JvmOverloads constructor(
    context: Context,
    ...
    override val finishedStrokeWidth =
        UIUtils.getDimension(R.dimen.arc_plan_progress_finished_stroke_width)
    override val unfinishedStrokeWidth =
        UIUtils.getDimension(R.dimen.arc_plan_progress_unfinished_stroke_width)
    override val myWalksFinishedStrokeWidth = if (useGreyBackground)
        UIUtils.getDimension(R.dimen.arc_walking_plan_progress_finished_stroke_width)
    else
        UIUtils.getDimension(R.dimen.walking_plan_widget_inner_stroke)
    ...
    fun setUpEmptyWalkingPlan() {
        isEmpty = true

        unfinishedStrokeColor = UIUtils.getColor(R.color.walking_plan_not_started_horseshoe)
        finishedStrokeColor = UIUtils.getColor(R.color.black_transparent_20)
        unfinishedProgressColor = UIUtils.getColor(R.color.walking_plan_not_started_horseshoe)
