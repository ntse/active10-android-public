...
import com.phe.betterhealth.widgets.databinding.BhCarouselA10LargeSubitemBinding

class CarouselA10LargeItemsAdapter :
    RecyclerAdapter<ArticlePageWrapper, CarouselA10LargeItemsAdapter.ViewHolder>(differ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(
        BhCarouselA10LargeSubitemBinding.inflate(
    ...
    class ViewHolder(val binding: BhCarouselA10LargeSubitemBinding) :
