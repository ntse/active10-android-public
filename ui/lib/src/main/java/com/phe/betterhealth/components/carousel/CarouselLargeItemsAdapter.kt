...
import com.phe.betterhealth.widgets.databinding.BhCarouselLargeSubitemBinding

class CarouselLargeItemsAdapter :
    RecyclerAdapter<ArticlePageWrapper, CarouselLargeItemsAdapter.ViewHolder>(differ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(
        BhCarouselLargeSubitemBinding.inflate(
    ...
    class ViewHolder(val binding: BhCarouselLargeSubitemBinding) :
