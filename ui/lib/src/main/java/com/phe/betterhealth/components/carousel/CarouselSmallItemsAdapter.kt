...
import com.phe.betterhealth.widgets.databinding.BhCarouselSmallSubitemBinding

class CarouselSmallItemsAdapter :
    ListAdapter<ArticlePageWrapper, CarouselSmallItemsAdapter.ViewHolder>(differ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(
        BhCarouselSmallSubitemBinding.inflate(
    ...
    class ViewHolder(val binding: BhCarouselSmallSubitemBinding) :
