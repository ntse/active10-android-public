...
import com.phe.betterhealth.widgets.databinding.BhCarouselWlpSmallSubitemBinding

class CarouselWlpSmallItemsAdapter :
    ListAdapter<ArticlePageWrapper, CarouselWlpSmallItemsAdapter.ViewHolder>(differ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(
        BhCarouselWlpSmallSubitemBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            contentDescription = buildString {
                append(getCarouselSlideContentDescription(item.infoPage, false))
                append(" - ")
    ...
    class ViewHolder(val binding: BhCarouselWlpSmallSubitemBinding) :
    ...
    companion object {
        val differ = object : DiffUtil.ItemCallback<ArticlePageWrapper>() {
            ...
            ) = oldItem.infoPage.id == newItem.infoPage.id
